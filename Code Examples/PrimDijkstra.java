...
public class PrimDijkstra {
    ...
    public PrimDijkstra(EdgeWeightedGraph G) {
        edgeTo = new Edge[G.V()];
    ...
    // scan vertex v Prims
    private void scanP(EdgeWeightedGraph G, int v) {
        marked[v] = true;
    ...
    private void scanD(EdgeWeightedGraph G, int v) {
        marked[v] = true;
        System.out.println("	Checking neighbors of " + v);
        for (Edge e : G.adj(v)) {
            int w = e.other(v);
    ...
    public static void main(String[] args) {
        ...
        StdOut.println("total weight = " + pd.weight());
        for (Edge e : pd.edges())
            StdOut.println(e);
    }
